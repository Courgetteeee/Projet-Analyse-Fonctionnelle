...
où B est la matrice D $\times$ q dont la d-ième ligne est $(B_1(t_d),...,B_q(t_d))$, $Y_i = (Y_{i1},...,Y_{iD})^T$ le vecteur des observations de l'entreprise i , et P est la matrice de pénalisation telle que $\beta^T P \beta = \displaystyle \int (f''_i(t))^2 dt .$
