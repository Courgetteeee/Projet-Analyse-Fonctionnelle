...
En spécifiant $method = \text{``REML''}$, l'algorithme reformule le problème de lissage sous la forme d'un modèle mixte. Le paramètre de pénalité $\lambda$ est alors estimé directement, comme un ratio entre la variance du signal et la variance du bruit.
